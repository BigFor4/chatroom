...
function GroupManagePanel(props: GroupManagePanelProps) {
    ...
    async function handleChangeGroupAvatar() {
        const image: any = await readDiskFIle(
            'blob',
        ...
        if (image.length > config.maxAvatarSize) {
            ...
            return Message.error('Failed to set group avatar, please select a picture smaller than 1.5MB');
        }
        ...
        try {
            ...
            if (isSuccess) {
                ...
                Message.success('Successfully changed the group avatar');
            }
        } catch (err) {
            console.error(err);
    ...
    async function handleDeleteGroup() {
        ...
        if (isSuccess) {
            ...
            Message.success('Successfully dissolved the group');
        }
    }
            ...
            >
                ...
                <div className={Style.content}>
                    ...
                    <Dialog
                        ...
                        title="Confirm once again if you want to disband the group?"
